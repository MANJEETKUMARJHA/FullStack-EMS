...
// // FIX: Added CircleDollarSign to the import list!
...
//         { id: 1, name: "Sarah Connor", action: "Clocked In", time: "08:55 AM", status: "success" },
//         { id: 2, name: "John Smith", action: "Leave Request", time: "09:12 AM", status: "warning" },
//         { id: 3, name: "Emily Chen", action: "Clocked In", time: "09:15 AM", status: "success" },
//     ];
...
//         { title: "Pending Leaves", value: data.pendingLeaves, icon: <FileText className="w-8 h-8 text-slate-600 dark:text-indigo-400" strokeWidth={1.5} /> },
//         // Now CircleDollarSign will work perfectly!
...
//                                                     activity.status === 'danger' ? 'badge-danger' : 
